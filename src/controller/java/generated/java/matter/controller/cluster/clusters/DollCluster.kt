...
class DollCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  suspend fun blink(eye: UByte, times: UByte, timedInvokeTimeout: Duration? = null) {
    val commandId: UInt = 0u

    val tlvWriter = TlvWriter()
    tlvWriter.startStructure(AnonymousTag)

    val TAG_EYE_REQ: Int = 0
    tlvWriter.put(ContextSpecificTag(TAG_EYE_REQ), eye)

    val TAG_TIMES_REQ: Int = 1
    tlvWriter.put(ContextSpecificTag(TAG_TIMES_REQ), times)
  ...
  suspend fun smile(timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun readLeftEyeStatusOfTheDollAttribute(): Boolean? {
    val ATTRIBUTE_ID: UInt = 1611005952u
    ...
    requireNotNull(attributeData) { "Lefteyestatusofthedoll attribute not found in response" }
  ...
  suspend fun writeLeftEyeStatusOfTheDollAttribute(
    value: Boolean,
  ...
  suspend fun subscribeLeftEyeStatusOfTheDollAttribute(
    minInterval: Int,
    maxInterval: Int,
      ...
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Lefteyestatusofthedoll attribute not found in Node State update"
          }
  ...
  suspend fun readRightEyeStatusOfTheDollAttribute(): Boolean? {
    val ATTRIBUTE_ID: UInt = 1611005953u
    ...
    requireNotNull(attributeData) { "Righteyestatusofthedoll attribute not found in response" }
  ...
  suspend fun writeRightEyeStatusOfTheDollAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null,
  ) {
    val ATTRIBUTE_ID: UInt = 1611005953u
  ...
  suspend fun subscribeRightEyeStatusOfTheDollAttribute(
    minInterval: Int,
    maxInterval: Int,
  ): Flow<BooleanSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 1611005953u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Righteyestatusofthedoll attribute not found in Node State update"
          }
  ...
  suspend fun readDescriptionAttribute(): String {
    val ATTRIBUTE_ID: UInt = 1611046912u
  ...
  companion object {
    private val logger = Logger.getLogger(DollCluster::class.java.name)
    const val CLUSTER_ID: UInt = 1611070464u
  }
}
