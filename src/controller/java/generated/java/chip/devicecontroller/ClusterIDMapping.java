...
public class ClusterIDMapping {
    ...
    public static class Doll implements BaseCluster {
        public static final long ID = 1611070464L;
        public long getID() {
            return ID;
        }

        public enum Attribute {
            LeftEyeStatusOfTheDoll(1611005952L),
            RightEyeStatusOfTheDoll(1611005953L),
            Description(1611046912L),
            GeneratedCommandList(65528L),
            AcceptedCommandList(65529L),
            EventList(65530L),
            AttributeList(65531L),
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum BlinkCommandField {Eye(0),Times(1),;
                    private final int id;
                    BlinkCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static BlinkCommandField value(int id) throws NoSuchFieldError {
                        for (BlinkCommandField field : BlinkCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
